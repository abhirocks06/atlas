...
export const SYSTEM_FAMILIES: SystemFamily[] = [
  ...
  { id: 'altius', label: 'ALTIUS Loitering Munition', match: /altius/i },
  { id: 'cuas', label: 'Counter-UAS Systems', match: /counter[- ]?unmanned|counter[- ]?uas|\bcuas\b/i },
  { id: 'switchblade', label: 'Switchblade Loitering Munition', match: /switchblade/i },

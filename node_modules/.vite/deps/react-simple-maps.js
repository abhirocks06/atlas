...
import {
  identity,
  zoom_default
} from "./chunk-AGIZ6ZIV.js";
import {
  select_default
} from "./chunk-RIHNT5BN.js";
import {
  __commonJS,
  __export,
  __toESM
...
function useZoomPan(_ref) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    var zoom$12 = zoom_default().filter(filterFunc).scaleExtent([minZoom, maxZoom]).translateExtent([[a1, a2], [b1, b2]]).on("start", handleZoomStart).on("zoom", handleZoom).on("end", handleZoomEnd);
